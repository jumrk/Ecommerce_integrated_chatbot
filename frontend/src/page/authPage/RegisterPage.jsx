                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            Đã có tài khoản?{' '}
                            <Link to="/login" className="text-blue-600 hover:text-blue-700 font-medium transition duration-300">
                                Đăng nhập
                            </Link>
                        </p>
                    </div>
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="flex items-center">
                            ...
                            <label className="ml-2 block text-sm text-gray-900">
                                Tôi đồng ý với <a href="#" className="text-blue-600 hover:text-blue-700">điều khoản</a> và{' '}
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            type="submit"
                            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-lg font-medium shadow-lg hover:shadow-xl transition duration-300"
                        >
                            Đăng ký
                        </motion.button>
