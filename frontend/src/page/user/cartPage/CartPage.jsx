...
const CartPage = () => {
    ...
    useEffect(() => {
        const fetchCart = async () => {
            try {
                ...
                setCartItems([]); // Đảm bảo không bị lỗi undefined
            } finally {
                setLoading(false);
            }
        };
    ...
    // Phí vận chuyển giả định (có thể sửa thành API trả về)
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                            {cartItems.map((item) => (
                                <SlideGridWhenVisible key={item.id} direction="up" delay={0.1}>
                                ...
                                <div className="bg-white rounded-2xl shadow-md p-4 sm:p-6 sticky top-8">
                                    ...
                                    <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                                        <div className="flex justify-between text-gray-600">
                                            <span>Tạm tính</span>
                                            <span className="font-medium">{getTotal().toLocaleString('vi-VN')}đ</span>
                                        </div>
                                        <div className="flex justify-between text-gray-600">
                                    ...
                                    <div className="border-t border-gray-100 pt-4 mb-4 sm:mb-6">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-xl sm:text-2xl font-bold text-primary-600">
                                                {(getTotal() + shippingFee).toLocaleString('vi-VN')}đ
                                            </span>
                                        </div>
                                    </div>
